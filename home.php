	...
	<p id="success"></p>
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				<?php
				$result = mysqli_query($conn,"SELECT * FROM ajaxtable");
					$i=1;
				...
				<tr id="<?php echo $row["id"]; ?>">
					...
					<td>
						<a href="#editData" class="edit" data-toggle="modal">
			...
			<div class="modal-content">
				<form id="user_form">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-success" id="btn-add">Add Data</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="modal-content">
				<form id="update_form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>contact</label>
							<input type="contact" id="contact_u" name="contact" class="form-control" required>
						</div>
